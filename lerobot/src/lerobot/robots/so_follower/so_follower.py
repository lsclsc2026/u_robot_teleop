...
class SOFollower(Robot):
    ...
    def configure(self) -> None:
        # USB serial links (notably CH343 devices forwarded through WSL USBIP)
        # can occasionally return a corrupt status packet. Retrying torque
        # transitions keeps a transient packet error from aborting bring-up.
